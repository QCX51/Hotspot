...
namespace Native
{
    ...
    public struct WLAN_INTERFACE_INFO_LIST
    {
        ...
        public WLAN_INTERFACE_INFO_LIST(ref IntPtr pList)
        {
            // The first 4 bytes are the number of WLAN_INTERFACE_INFO structures.
            dwNumberOfItems = pList != IntPtr.Zero ? Marshal.ReadInt64(pList, 0) : 0;
            // The next 4 bytes are the index of the current item in the unmanaged API.
            dwIndex = pList != IntPtr.Zero ? Marshal.ReadInt64(pList, 4) : 0;
            ...
            for (int i = 0; i < dwNumberOfItems; i++)
            {
                ...
                // the length of the WLAN_INTERFACE_INFO structure is 532 bytes
                // this was determined by doing a sizeof(WLAN_INTERFACE_INFO) in an unmanaged C++ app.
